...
class _ConversionState extends State<Conversion> {
  ...
  void initState() {
    ...
    this.email = widget.pdfPersonalDetails;
  }
        ...
        ..addPage(Pdf.MultiPage(
            ...
            footer: (Pdf.Context context) {
              return Pdf.Container(
                  ...
                  margin:
                      const Pdf.EdgeInsets.only(top: 1.0 * PdfPageFormat.cm),
                  child: Pdf.Text(
            ...
            build: (Pdf.Context context) => <Pdf.Widget>[
                  ...
                  Pdf.Column(children: <Pdf.Widget>[
                    ...
                    Pdf.Row(children: <Pdf.Widget>[
                      ...
                      Pdf.Text('Kaushal kumar'),
                    ]),
                    Pdf.Row(children: <Pdf.Widget>[
                      Pdf.Text('Email: ',
                          style:
                              Pdf.TextStyle(fontWeight: Pdf.FontWeight.bold)),
                      Pdf.Text("kaushal.deligence@gmail"),
                    ]),
                    Pdf.Row(children: <Pdf.Widget>[
                      Pdf.Paragraph(
                          text: 'Address: ',
